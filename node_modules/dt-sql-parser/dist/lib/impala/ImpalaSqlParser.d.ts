...
export declare class ImpalaSqlParser extends SQLParserBase {
    ...
    static readonly RULE_viewColumnItem = 102;
    static readonly RULE_queryStatement = 103;
    static readonly RULE_with = 104;
    static readonly RULE_constraintSpecification = 105;
    static readonly RULE_foreignKeySpecification = 106;
    static readonly RULE_columnSpec = 107;
    static readonly RULE_columnDefinition = 108;
    static readonly RULE_kuduTableElement = 109;
    static readonly RULE_kuduColumnDefinition = 110;
    static readonly RULE_commentClause = 111;
    static readonly RULE_columnSpecWithKudu = 112;
    static readonly RULE_createColumnSpecWithKudu = 113;
    static readonly RULE_kuduAttributes = 114;
    static readonly RULE_kuduStorageAttr = 115;
    static readonly RULE_statsKey = 116;
    static readonly RULE_fileFormat = 117;
    static readonly RULE_kuduPartitionClause = 118;
    static readonly RULE_hashClause = 119;
    static readonly RULE_rangeClause = 120;
    static readonly RULE_kuduPartitionSpec = 121;
    static readonly RULE_cacheSpec = 122;
    static readonly RULE_rangeOperator = 123;
    static readonly RULE_partitionCol = 124;
    static readonly RULE_likeClause = 125;
    static readonly RULE_properties = 126;
    static readonly RULE_partitionedBy = 127;
    static readonly RULE_sortedBy = 128;
    static readonly RULE_rowFormat = 129;
    static readonly RULE_property = 130;
    static readonly RULE_queryNoWith = 131;
    static readonly RULE_queryTerm = 132;
    static readonly RULE_queryPrimary = 133;
    static readonly RULE_sortItem = 134;
    static readonly RULE_querySpecification = 135;
    static readonly RULE_groupBy = 136;
    static readonly RULE_groupingElement = 137;
    static readonly RULE_groupingSet = 138;
    static readonly RULE_namedQuery = 139;
    static readonly RULE_setQuantifier = 140;
    static readonly RULE_selectItem = 141;
    static readonly RULE_relation = 142;
    static readonly RULE_joinType = 143;
    static readonly RULE_joinCriteria = 144;
    static readonly RULE_sampledRelation = 145;
    static readonly RULE_sampleType = 146;
    static readonly RULE_aliasedRelation = 147;
    static readonly RULE_columnAliases = 148;
    static readonly RULE_relationPrimary = 149;
    static readonly RULE_subQueryRelation = 150;
    static readonly RULE_unnest = 151;
    static readonly RULE_parenthesizedRelation = 152;
    static readonly RULE_columnItem = 153;
    static readonly RULE_expression = 154;
    static readonly RULE_booleanExpression = 155;
    static readonly RULE_predicate = 156;
    static readonly RULE_valueExpression = 157;
    static readonly RULE_primaryExpression = 158;
    static readonly RULE_stringLiteral = 159;
    static readonly RULE_comparisonOperator = 160;
    static readonly RULE_comparisonQuantifier = 161;
    static readonly RULE_booleanValue = 162;
    static readonly RULE_interval = 163;
    static readonly RULE_intervalField = 164;
    static readonly RULE_normalForm = 165;
    static readonly RULE_type = 166;
    static readonly RULE_dataType = 167;
    static readonly RULE_typeParameter = 168;
    static readonly RULE_baseType = 169;
    static readonly RULE_whenClause = 170;
    static readonly RULE_filter = 171;
    static readonly RULE_over = 172;
    static readonly RULE_windowFrame = 173;
    static readonly RULE_frameBound = 174;
    static readonly RULE_pathElement = 175;
    static readonly RULE_pathSpecification = 176;
    static readonly RULE_privilege = 177;
    static readonly RULE_objectType = 178;
    static readonly RULE_qualifiedName = 179;
    static readonly RULE_principal = 180;
    static readonly RULE_identifier = 181;
    static readonly RULE_number = 182;
    static readonly RULE_reservedKeywordsUsedAsFuncName = 183;
    static readonly RULE_nonReserved = 184;
...
export declare class ViewColumnsContext extends antlr.ParserRuleContext {
    ...
    RPAREN(): antlr.TerminalNode;
    viewColumnItem(): ViewColumnItemContext[];
    viewColumnItem(i: number): ViewColumnItemContext | null;
    COMMA(): antlr.TerminalNode[];
    COMMA(i: number): antlr.TerminalNode | null;
    get ruleIndex(): number;
    enterRule(listener: ImpalaSqlParserListener): void;
...
export declare class ViewColumnItemContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
    columnNamePathCreate(): ColumnNamePathCreateContext;
    commentClause(): CommentClauseContext | null;
    get ruleIndex(): number;
...
export declare class CommentClauseContext extends antlr.ParserRuleContext {
