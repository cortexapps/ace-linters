...
export declare class TrinoSqlParser extends SQLParserBase {
    ...
    static readonly SIMPLE_COMMENT = 336;
    static readonly BRACKETED_COMMENT = 337;
    static readonly WS = 338;
    ...
    static readonly RULE_groupBy = 27;
    static readonly RULE_groupingElement = 28;
    static readonly RULE_groupingSet = 29;
    static readonly RULE_groupingTerm = 30;
    static readonly RULE_windowDefinition = 31;
    static readonly RULE_windowSpecification = 32;
    static readonly RULE_namedQuery = 33;
    static readonly RULE_setQuantifier = 34;
    static readonly RULE_selectItem = 35;
    static readonly RULE_relation = 36;
    static readonly RULE_joinType = 37;
    static readonly RULE_joinCriteria = 38;
    static readonly RULE_sampledRelation = 39;
    static readonly RULE_sampleType = 40;
    static readonly RULE_trimsSpecification = 41;
    static readonly RULE_listAggOverflowBehavior = 42;
    static readonly RULE_listaggCountIndication = 43;
    static readonly RULE_patternRecognition = 44;
    static readonly RULE_measureDefinition = 45;
    static readonly RULE_rowsPerMatch = 46;
    static readonly RULE_emptyMatchHandling = 47;
    static readonly RULE_skipTo = 48;
    static readonly RULE_subsetDefinition = 49;
    static readonly RULE_variableDefinition = 50;
    static readonly RULE_aliasedRelation = 51;
    static readonly RULE_columnListCreate = 52;
    static readonly RULE_columnList = 53;
    static readonly RULE_columnAliases = 54;
    static readonly RULE_relationPrimary = 55;
    static readonly RULE_jsonTableColumn = 56;
    static readonly RULE_jsonTableSpecificPlan = 57;
    static readonly RULE_jsonTablePathName = 58;
    static readonly RULE_planPrimary = 59;
    static readonly RULE_jsonTableDefaultPlan = 60;
    static readonly RULE_tableFunctionCall = 61;
    static readonly RULE_tableFunctionArgument = 62;
    static readonly RULE_tableArgument = 63;
    static readonly RULE_tableArgumentRelation = 64;
    static readonly RULE_descriptorArgument = 65;
    static readonly RULE_descriptorField = 66;
    static readonly RULE_copartitionTables = 67;
    static readonly RULE_expression = 68;
    static readonly RULE_booleanExpression = 69;
    static readonly RULE_predicate = 70;
    static readonly RULE_valueExpression = 71;
    static readonly RULE_primaryExpression = 72;
    static readonly RULE_jsonPathInvocation = 73;
    static readonly RULE_jsonValueExpression = 74;
    static readonly RULE_jsonRepresentation = 75;
    static readonly RULE_jsonArgument = 76;
    static readonly RULE_jsonExistsErrorBehavior = 77;
    static readonly RULE_jsonValueBehavior = 78;
    static readonly RULE_jsonQueryWrapperBehavior = 79;
    static readonly RULE_jsonQueryBehavior = 80;
    static readonly RULE_jsonObjectMember = 81;
    static readonly RULE_processingMode = 82;
    static readonly RULE_nullTreatment = 83;
    static readonly RULE_string = 84;
    static readonly RULE_timeZoneSpecifier = 85;
    static readonly RULE_comparisonOperator = 86;
    static readonly RULE_comparisonQuantifier = 87;
    static readonly RULE_booleanValue = 88;
    static readonly RULE_interval = 89;
    static readonly RULE_intervalField = 90;
    static readonly RULE_normalForm = 91;
    static readonly RULE_type = 92;
    static readonly RULE_rowField = 93;
    static readonly RULE_typeParameter = 94;
    static readonly RULE_whenClause = 95;
    static readonly RULE_filter = 96;
    static readonly RULE_mergeCase = 97;
    static readonly RULE_over = 98;
    static readonly RULE_windowFrame = 99;
    static readonly RULE_frameExtent = 100;
    static readonly RULE_frameBound = 101;
    static readonly RULE_rowPattern = 102;
    static readonly RULE_patternPrimary = 103;
    static readonly RULE_patternQuantifier = 104;
    static readonly RULE_updateAssignment = 105;
    static readonly RULE_explainOption = 106;
    static readonly RULE_transactionMode = 107;
    static readonly RULE_levelOfIsolation = 108;
    static readonly RULE_callArgument = 109;
    static readonly RULE_pathElement = 110;
    static readonly RULE_pathSpecification = 111;
    static readonly RULE_functionSpecification = 112;
    static readonly RULE_functionDeclaration = 113;
    static readonly RULE_functionSignature = 114;
    static readonly RULE_parameterDeclaration = 115;
    static readonly RULE_returnsClause = 116;
    static readonly RULE_routineCharacteristic = 117;
    static readonly RULE_controlStatement = 118;
    static readonly RULE_caseStatementWhenClause = 119;
    static readonly RULE_elseIfClause = 120;
    static readonly RULE_elseClause = 121;
    static readonly RULE_variableDeclaration = 122;
    static readonly RULE_sqlStatementList = 123;
    static readonly RULE_privilege = 124;
    static readonly RULE_entityKind = 125;
    static readonly RULE_grantObject = 126;
    static readonly RULE_tableOrViewName = 127;
    static readonly RULE_tableRef = 128;
    static readonly RULE_tableNameCreate = 129;
    static readonly RULE_viewRef = 130;
    static readonly RULE_viewNameCreate = 131;
    static readonly RULE_schemaRef = 132;
    static readonly RULE_schemaNameCreate = 133;
    static readonly RULE_catalogRef = 134;
    static readonly RULE_catalogNameCreate = 135;
    static readonly RULE_functionName = 136;
    static readonly RULE_functionNameCreate = 137;
    static readonly RULE_columnRef = 138;
    static readonly RULE_columnNameCreate = 139;
    static readonly RULE_qualifiedName = 140;
    static readonly RULE_queryPeriod = 141;
    static readonly RULE_rangeType = 142;
    static readonly RULE_grantor = 143;
    static readonly RULE_principal = 144;
    static readonly RULE_roles = 145;
    static readonly RULE_privilegeOrRole = 146;
    static readonly RULE_identifier = 147;
    static readonly RULE_number = 148;
    static readonly RULE_authorizationUser = 149;
    static readonly RULE_nonReserved = 150;
...
export declare class ExplainAnalyzeContext extends StatementContext {
    constructor(ctx: StatementContext);
    KW_EXPLAIN(): antlr.TerminalNode;
...
export declare class DropCatalogContext extends StatementContext {
    _catalog?: CatalogRefContext;
    constructor(ctx: StatementContext);
    KW_DROP(): antlr.TerminalNode;
...
export declare class ShowGrantsContext extends StatementContext {
    ...
    grantObject(): GrantObjectContext | null;
    enterRule(listener: TrinoSqlListener): void;
    exitRule(listener: TrinoSqlListener): void;
    accept<Result>(visitor: TrinoSqlVisitor<Result>): Result | null;
}
...
export declare class ResetSessionAuthorizationContext extends StatementContext {
    constructor(ctx: StatementContext);
    KW_RESET(): antlr.TerminalNode;
    KW_SESSION(): antlr.TerminalNode;
    KW_AUTHORIZATION(): antlr.TerminalNode;
...
export declare class GrantPrivilegesContext extends StatementContext {
    constructor(ctx: StatementContext);
...
export declare class CreateTableAsSelectContext extends StatementContext {
    ...
    rootQuery(): RootQueryContext | null;
    KW_OR(): antlr.TerminalNode | null;
    KW_REPLACE(): antlr.TerminalNode | null;
    KW_IF(): antlr.TerminalNode | null;
    KW_NOT(): antlr.TerminalNode | null;
...
export declare class CommentViewContext extends StatementContext {
    constructor(ctx: StatementContext);
    KW_COMMENT(): antlr.TerminalNode;
    KW_ON(): antlr.TerminalNode;
    KW_VIEW(): antlr.TerminalNode;
...
export declare class RevokePrivilegesContext extends StatementContext {
    _grantee?: PrincipalContext;
    constructor(ctx: StatementContext);
    KW_REVOKE(): antlr.TerminalNode;
    KW_ON(): antlr.TerminalNode;
...
export declare class TableExecuteContext extends StatementContext {
    _tableName?: TableRefContext;
    _procedureName?: FunctionNameContext;
    _where?: BooleanExpressionContext;
    constructor(ctx: StatementContext);
    KW_ALTER(): antlr.TerminalNode;
    KW_TABLE(): antlr.TerminalNode;
...
export declare class SetColumnTypeContext extends StatementContext {
    _tableName?: TableRefContext;
    _column?: ColumnRefContext;
    constructor(ctx: StatementContext);
    KW_ALTER(): antlr.TerminalNode[];
...
export declare class CreateMaterializedViewContext extends StatementContext {
    ...
    KW_NOT(): antlr.TerminalNode | null;
    KW_EXISTS(): antlr.TerminalNode | null;
    KW_GRACE(): antlr.TerminalNode | null;
    KW_PERIOD(): antlr.TerminalNode | null;
...
export declare class ExecuteImmediateContext extends StatementContext {
    constructor(ctx: StatementContext);
    KW_EXECUTE(): antlr.TerminalNode;
    KW_IMMEDIATE(): antlr.TerminalNode;
...
export declare class CreateCatalogContext extends StatementContext {
    _catalog?: CatalogNameCreateContext;
    _connectorName?: IdentifierContext;
    constructor(ctx: StatementContext);
    KW_CREATE(): antlr.TerminalNode;
    KW_CATALOG(): antlr.TerminalNode;
    KW_USING(): antlr.TerminalNode;
...
export declare class RootQueryContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
    query(): QueryContext;
    withFunction(): WithFunctionContext | null;
    get ruleIndex(): number;
    enterRule(listener: TrinoSqlListener): void;
    exitRule(listener: TrinoSqlListener): void;
    accept<Result>(visitor: TrinoSqlVisitor<Result>): Result | null;
}
export declare class WithFunctionContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
    KW_WITH(): antlr.TerminalNode;
    functionSpecification(): FunctionSpecificationContext[];
    functionSpecification(i: number): FunctionSpecificationContext | null;
    get ruleIndex(): number;
    enterRule(listener: TrinoSqlListener): void;
    exitRule(listener: TrinoSqlListener): void;
    accept<Result>(visitor: TrinoSqlVisitor<Result>): Result | null;
...
export declare class TrimsSpecificationContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
...
export declare class ListAggOverflowBehaviorContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
    KW_ERROR(): antlr.TerminalNode | null;
    KW_TRUNCATE(): antlr.TerminalNode | null;
    listaggCountIndication(): ListaggCountIndicationContext | null;
    string(): StringContext | null;
    get ruleIndex(): number;
    enterRule(listener: TrinoSqlListener): void;
    exitRule(listener: TrinoSqlListener): void;
...
export declare class ListaggCountIndicationContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
    KW_WITH(): antlr.TerminalNode | null;
...
export declare class ColumnListContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
    columnRef(): ColumnRefContext[];
    columnRef(i: number): ColumnRefContext | null;
    get ruleIndex(): number;
    enterRule(listener: TrinoSqlListener): void;
    exitRule(listener: TrinoSqlListener): void;
    accept<Result>(visitor: TrinoSqlVisitor<Result>): Result | null;
...
export declare class JsonTableContext extends RelationPrimaryContext {
    constructor(ctx: RelationPrimaryContext);
    KW_JSON_TABLE(): antlr.TerminalNode;
    jsonPathInvocation(): JsonPathInvocationContext;
    KW_COLUMNS(): antlr.TerminalNode;
    jsonTableColumn(): JsonTableColumnContext[];
    jsonTableColumn(i: number): JsonTableColumnContext | null;
    KW_PLAN(): antlr.TerminalNode | null;
    jsonTableSpecificPlan(): JsonTableSpecificPlanContext | null;
    KW_DEFAULT(): antlr.TerminalNode | null;
    jsonTableDefaultPlan(): JsonTableDefaultPlanContext | null;
    KW_ON(): antlr.TerminalNode | null;
...
export declare class TableFunctionInvocationContext extends RelationPrimaryContext {
    constructor(ctx: RelationPrimaryContext);
    KW_TABLE(): antlr.TerminalNode;
    tableFunctionCall(): TableFunctionCallContext;
    enterRule(listener: TrinoSqlListener): void;
...
export declare class TableNameContext extends RelationPrimaryContext {
    constructor(ctx: RelationPrimaryContext);
    tableOrViewName(): TableOrViewNameContext;
    queryPeriod(): QueryPeriodContext | null;
    enterRule(listener: TrinoSqlListener): void;
    exitRule(listener: TrinoSqlListener): void;
    accept<Result>(visitor: TrinoSqlVisitor<Result>): Result | null;
}
export declare class JsonTableColumnContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
    get ruleIndex(): number;
    copyFrom(ctx: JsonTableColumnContext): void;
}
export declare class QueryColumnContext extends JsonTableColumnContext {
    _emptyBehavior?: JsonQueryBehaviorContext;
    _errorBehavior?: JsonQueryBehaviorContext;
    ...
    string(): StringContext | null;
    jsonQueryWrapperBehavior(): JsonQueryWrapperBehaviorContext | null;
    KW_WRAPPER(): antlr.TerminalNode | null;
    KW_QUOTES(): antlr.TerminalNode | null;
    KW_ON(): antlr.TerminalNode[];
    KW_ON(i: number): antlr.TerminalNode | null;
    KW_EMPTY(): antlr.TerminalNode | null;
    KW_ERROR(): antlr.TerminalNode | null;
    KW_KEEP(): antlr.TerminalNode | null;
    KW_OMIT(): antlr.TerminalNode | null;
    jsonQueryBehavior(): JsonQueryBehaviorContext[];
    jsonQueryBehavior(i: number): JsonQueryBehaviorContext | null;
    KW_SCALAR(): antlr.TerminalNode | null;
    KW_TEXT_STRING(): antlr.TerminalNode | null;
    enterRule(listener: TrinoSqlListener): void;
    exitRule(listener: TrinoSqlListener): void;
    accept<Result>(visitor: TrinoSqlVisitor<Result>): Result | null;
}
export declare class NestedColumnsContext extends JsonTableColumnContext {
    constructor(ctx: JsonTableColumnContext);
    KW_NESTED(): antlr.TerminalNode;
    string(): StringContext;
    KW_COLUMNS(): antlr.TerminalNode;
    jsonTableColumn(): JsonTableColumnContext[];
    jsonTableColumn(i: number): JsonTableColumnContext | null;
...
export declare class ValueColumnContext extends JsonTableColumnContext {
    _emptyBehavior?: JsonValueBehaviorContext;
    _errorBehavior?: JsonValueBehaviorContext;
    constructor(ctx: JsonTableColumnContext);
    identifier(): IdentifierContext;
    type(): TypeContext;
    KW_PATH(): antlr.TerminalNode | null;
    ...
    KW_ERROR(): antlr.TerminalNode | null;
    jsonValueBehavior(): JsonValueBehaviorContext[];
    jsonValueBehavior(i: number): JsonValueBehaviorContext | null;
    enterRule(listener: TrinoSqlListener): void;
    exitRule(listener: TrinoSqlListener): void;
    accept<Result>(visitor: TrinoSqlVisitor<Result>): Result | null;
}
export declare class OrdinalityColumnContext extends JsonTableColumnContext {
    constructor(ctx: JsonTableColumnContext);
    identifier(): IdentifierContext;
    KW_FOR(): antlr.TerminalNode;
...
export declare class JsonTableSpecificPlanContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
    get ruleIndex(): number;
    copyFrom(ctx: JsonTableSpecificPlanContext): void;
}
export declare class CrossPlanContext extends JsonTableSpecificPlanContext {
    constructor(ctx: JsonTableSpecificPlanContext);
    planPrimary(): PlanPrimaryContext[];
    planPrimary(i: number): PlanPrimaryContext | null;
...
export declare class JoinPlanContext extends JsonTableSpecificPlanContext {
    constructor(ctx: JsonTableSpecificPlanContext);
    jsonTablePathName(): JsonTablePathNameContext;
    planPrimary(): PlanPrimaryContext;
    KW_OUTER(): antlr.TerminalNode | null;
...
export declare class LeafPlanContext extends JsonTableSpecificPlanContext {
    constructor(ctx: JsonTableSpecificPlanContext);
    jsonTablePathName(): JsonTablePathNameContext;
    enterRule(listener: TrinoSqlListener): void;
    exitRule(listener: TrinoSqlListener): void;
...
export declare class UnionPlanContext extends JsonTableSpecificPlanContext {
    constructor(ctx: JsonTableSpecificPlanContext);
    planPrimary(): PlanPrimaryContext[];
    planPrimary(i: number): PlanPrimaryContext | null;
...
export declare class JsonTablePathNameContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
    identifier(): IdentifierContext;
    get ruleIndex(): number;
    enterRule(listener: TrinoSqlListener): void;
...
export declare class PlanPrimaryContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
    jsonTablePathName(): JsonTablePathNameContext | null;
    jsonTableSpecificPlan(): JsonTableSpecificPlanContext | null;
    get ruleIndex(): number;
    enterRule(listener: TrinoSqlListener): void;
    exitRule(listener: TrinoSqlListener): void;
...
export declare class JsonTableDefaultPlanContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
    KW_OUTER(): antlr.TerminalNode | null;
    KW_INNER(): antlr.TerminalNode | null;
    KW_UNION(): antlr.TerminalNode | null;
...
export declare class TableFunctionCallContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
    functionName(): FunctionNameContext;
    tableFunctionArgument(): TableFunctionArgumentContext[];
    tableFunctionArgument(i: number): TableFunctionArgumentContext | null;
    KW_COPARTITION(): antlr.TerminalNode | null;
    copartitionTables(): CopartitionTablesContext[];
    copartitionTables(i: number): CopartitionTablesContext | null;
    get ruleIndex(): number;
    enterRule(listener: TrinoSqlListener): void;
    exitRule(listener: TrinoSqlListener): void;
    accept<Result>(visitor: TrinoSqlVisitor<Result>): Result | null;
}
export declare class TableFunctionArgumentContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
    tableArgument(): TableArgumentContext | null;
    descriptorArgument(): DescriptorArgumentContext | null;
    expression(): ExpressionContext | null;
    identifier(): IdentifierContext | null;
    get ruleIndex(): number;
    enterRule(listener: TrinoSqlListener): void;
...
export declare class TableArgumentContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
    tableArgumentRelation(): TableArgumentRelationContext;
    KW_PARTITION(): antlr.TerminalNode | null;
    KW_BY(): antlr.TerminalNode[];
    KW_BY(i: number): antlr.TerminalNode | null;
    KW_PRUNE(): antlr.TerminalNode | null;
...
export declare class TableArgumentRelationContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
    get ruleIndex(): number;
    copyFrom(ctx: TableArgumentRelationContext): void;
}
export declare class TableArgumentQueryContext extends TableArgumentRelationContext {
...
export declare class TableArgumentTableContext extends TableArgumentRelationContext {
    constructor(ctx: TableArgumentRelationContext);
    KW_TABLE(): antlr.TerminalNode;
    tableRef(): TableRefContext;
    identifier(): IdentifierContext | null;
...
export declare class DescriptorArgumentContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
    KW_DESCRIPTOR(): antlr.TerminalNode;
    descriptorField(): DescriptorFieldContext[];
    descriptorField(i: number): DescriptorFieldContext | null;
...
export declare class DescriptorFieldContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
    identifier(): IdentifierContext;
...
export declare class CopartitionTablesContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
    qualifiedName(): QualifiedNameContext[];
...
export declare class OrContext extends BooleanExpressionContext {
    constructor(ctx: BooleanExpressionContext);
    booleanExpression(): BooleanExpressionContext[];
    booleanExpression(i: number): BooleanExpressionContext | null;
...
export declare class AndContext extends BooleanExpressionContext {
    constructor(ctx: BooleanExpressionContext);
    booleanExpression(): BooleanExpressionContext[];
    booleanExpression(i: number): BooleanExpressionContext | null;
...
export declare class JsonValueContext extends PrimaryExpressionContext {
    _emptyBehavior?: JsonValueBehaviorContext;
    _errorBehavior?: JsonValueBehaviorContext;
    constructor(ctx: PrimaryExpressionContext);
...
export declare class TrimContext extends PrimaryExpressionContext {
    _trimChar?: ValueExpressionContext;
    _trimSource?: ValueExpressionContext;
    constructor(ctx: PrimaryExpressionContext);
    KW_TRIM(): antlr.TerminalNode;
    valueExpression(): ValueExpressionContext[];
    valueExpression(i: number): ValueExpressionContext | null;
    KW_FROM(): antlr.TerminalNode | null;
    trimsSpecification(): TrimsSpecificationContext | null;
    enterRule(listener: TrinoSqlListener): void;
    exitRule(listener: TrinoSqlListener): void;
    accept<Result>(visitor: TrinoSqlVisitor<Result>): Result | null;
}
...
export declare class JsonObjectContext extends PrimaryExpressionContext {
    constructor(ctx: PrimaryExpressionContext);
    KW_JSON_OBJECT(): antlr.TerminalNode;
    jsonObjectMember(): JsonObjectMemberContext[];
    jsonObjectMember(i: number): JsonObjectMemberContext | null;
    KW_RETURNING(): antlr.TerminalNode | null;
    type(): TypeContext | null;
    KW_NULL(): antlr.TerminalNode[];
    KW_NULL(i: number): antlr.TerminalNode | null;
    KW_ON(): antlr.TerminalNode | null;
    KW_ABSENT(): antlr.TerminalNode | null;
    KW_WITH(): antlr.TerminalNode | null;
    KW_UNIQUE(): antlr.TerminalNode | null;
    KW_WITHOUT(): antlr.TerminalNode | null;
    KW_FORMAT(): antlr.TerminalNode | null;
    jsonRepresentation(): JsonRepresentationContext | null;
...
export declare class JsonArrayContext extends PrimaryExpressionContext {
    constructor(ctx: PrimaryExpressionContext);
    KW_JSON_ARRAY(): antlr.TerminalNode;
    jsonValueExpression(): JsonValueExpressionContext[];
    jsonValueExpression(i: number): JsonValueExpressionContext | null;
    KW_RETURNING(): antlr.TerminalNode | null;
    type(): TypeContext | null;
    KW_NULL(): antlr.TerminalNode[];
    KW_NULL(i: number): antlr.TerminalNode | null;
...
export declare class JsonExistsContext extends PrimaryExpressionContext {
    constructor(ctx: PrimaryExpressionContext);
    KW_JSON_EXISTS(): antlr.TerminalNode;
    jsonPathInvocation(): JsonPathInvocationContext;
    jsonExistsErrorBehavior(): JsonExistsErrorBehaviorContext | null;
    KW_ON(): antlr.TerminalNode | null;
    KW_ERROR(): antlr.TerminalNode | null;
    enterRule(listener: TrinoSqlListener): void;
    exitRule(listener: TrinoSqlListener): void;
...
export declare class JsonQueryContext extends PrimaryExpressionContext {
    _emptyBehavior?: JsonQueryBehaviorContext;
    _errorBehavior?: JsonQueryBehaviorContext;
    constructor(ctx: PrimaryExpressionContext);
...
export declare class ListaggContext extends PrimaryExpressionContext {
    _name?: Token | null;
    constructor(ctx: PrimaryExpressionContext);
    expression(): ExpressionContext;
    KW_LISTAGG(): antlr.TerminalNode;
    ...
    string(): StringContext | null;
    KW_ON(): antlr.TerminalNode | null;
    KW_OVERFLOW(): antlr.TerminalNode | null;
    listAggOverflowBehavior(): ListAggOverflowBehaviorContext | null;
    filter(): FilterContext | null;
    enterRule(listener: TrinoSqlListener): void;
    exitRule(listener: TrinoSqlListener): void;
    accept<Result>(visitor: TrinoSqlVisitor<Result>): Result | null;
...
export declare class JsonPathInvocationContext extends antlr.ParserRuleContext {
    _path?: StringContext;
    _pathName?: IdentifierContext;
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
    jsonValueExpression(): JsonValueExpressionContext;
    string(): StringContext;
    KW_AS(): antlr.TerminalNode | null;
    ...
    jsonArgument(): JsonArgumentContext[];
    jsonArgument(i: number): JsonArgumentContext | null;
    identifier(): IdentifierContext | null;
    get ruleIndex(): number;
    enterRule(listener: TrinoSqlListener): void;
    exitRule(listener: TrinoSqlListener): void;
...
export declare class JsonValueExpressionContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
    expression(): ExpressionContext;
    KW_FORMAT(): antlr.TerminalNode | null;
    jsonRepresentation(): JsonRepresentationContext | null;
...
export declare class JsonRepresentationContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
...
export declare class JsonArgumentContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
    jsonValueExpression(): JsonValueExpressionContext;
    KW_AS(): antlr.TerminalNode;
    identifier(): IdentifierContext;
...
export declare class JsonExistsErrorBehaviorContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
...
export declare class JsonValueBehaviorContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
    KW_ERROR(): antlr.TerminalNode | null;
    KW_NULL(): antlr.TerminalNode | null;
    KW_DEFAULT(): antlr.TerminalNode | null;
...
export declare class JsonQueryWrapperBehaviorContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
    KW_WITHOUT(): antlr.TerminalNode | null;
    KW_ARRAY(): antlr.TerminalNode | null;
    KW_WITH(): antlr.TerminalNode | null;
    KW_CONDITIONAL(): antlr.TerminalNode | null;
    KW_UNCONDITIONAL(): antlr.TerminalNode | null;
    get ruleIndex(): number;
    enterRule(listener: TrinoSqlListener): void;
    exitRule(listener: TrinoSqlListener): void;
    accept<Result>(visitor: TrinoSqlVisitor<Result>): Result | null;
}
export declare class JsonQueryBehaviorContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
    KW_ERROR(): antlr.TerminalNode | null;
    KW_NULL(): antlr.TerminalNode | null;
    KW_EMPTY(): antlr.TerminalNode | null;
...
export declare class JsonObjectMemberContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
    expression(): ExpressionContext;
...
export declare class TimeTypeContext extends TypeContext {
    _base?: Token | null;
...
export declare class FunctionSpecificationContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
    KW_FUNCTION(): antlr.TerminalNode;
    functionDeclaration(): FunctionDeclarationContext;
    returnsClause(): ReturnsClauseContext;
    controlStatement(): ControlStatementContext;
    routineCharacteristic(): RoutineCharacteristicContext[];
    routineCharacteristic(i: number): RoutineCharacteristicContext | null;
    get ruleIndex(): number;
    enterRule(listener: TrinoSqlListener): void;
    exitRule(listener: TrinoSqlListener): void;
    accept<Result>(visitor: TrinoSqlVisitor<Result>): Result | null;
...
export declare class FunctionSignatureContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
    functionName(): FunctionNameContext;
    parameterDeclaration(): ParameterDeclarationContext[];
    parameterDeclaration(i: number): ParameterDeclarationContext | null;
...
export declare class ReturnsClauseContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
...
export declare class RoutineCharacteristicContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
    get ruleIndex(): number;
    copyFrom(ctx: RoutineCharacteristicContext): void;
}
export declare class ReturnsNullOnNullInputCharacteristicContext extends RoutineCharacteristicContext {
...
export declare class SecurityCharacteristicContext extends RoutineCharacteristicContext {
    constructor(ctx: RoutineCharacteristicContext);
...
export declare class CalledOnNullInputCharacteristicContext extends RoutineCharacteristicContext {
    constructor(ctx: RoutineCharacteristicContext);
    KW_CALLED(): antlr.TerminalNode;
    KW_ON(): antlr.TerminalNode;
    KW_NULL(): antlr.TerminalNode;
    KW_INPUT(): antlr.TerminalNode;
    enterRule(listener: TrinoSqlListener): void;
...
export declare class CommentCharacteristicContext extends RoutineCharacteristicContext {
    constructor(ctx: RoutineCharacteristicContext);
    KW_COMMENT(): antlr.TerminalNode;
    string(): StringContext;
    enterRule(listener: TrinoSqlListener): void;
...
export declare class LanguageCharacteristicContext extends RoutineCharacteristicContext {
    constructor(ctx: RoutineCharacteristicContext);
...
export declare class DeterministicCharacteristicContext extends RoutineCharacteristicContext {
    constructor(ctx: RoutineCharacteristicContext);
...
export declare class ControlStatementContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
    get ruleIndex(): number;
    copyFrom(ctx: ControlStatementContext): void;
}
export declare class WhileStatementContext extends ControlStatementContext {
    _label?: IdentifierContext;
...
export declare class SimpleCaseStatementContext extends ControlStatementContext {
    constructor(ctx: ControlStatementContext);
    KW_CASE(): antlr.TerminalNode[];
    ...
    KW_END(): antlr.TerminalNode;
    caseStatementWhenClause(): CaseStatementWhenClauseContext[];
    caseStatementWhenClause(i: number): CaseStatementWhenClauseContext | null;
    elseClause(): ElseClauseContext | null;
    enterRule(listener: TrinoSqlListener): void;
    exitRule(listener: TrinoSqlListener): void;
    accept<Result>(visitor: TrinoSqlVisitor<Result>): Result | null;
}
export declare class RepeatStatementContext extends ControlStatementContext {
    _label?: IdentifierContext;
    constructor(ctx: ControlStatementContext);
...
export declare class AssignmentStatementContext extends ControlStatementContext {
    constructor(ctx: ControlStatementContext);
    KW_SET(): antlr.TerminalNode;
    identifier(): IdentifierContext;
    EQ(): antlr.TerminalNode;
...
export declare class LeaveStatementContext extends ControlStatementContext {
    constructor(ctx: ControlStatementContext);
...
export declare class CompoundStatementContext extends ControlStatementContext {
    constructor(ctx: ControlStatementContext);
    ...
    sqlStatementList(): SqlStatementListContext | null;
    enterRule(listener: TrinoSqlListener): void;
    exitRule(listener: TrinoSqlListener): void;
    accept<Result>(visitor: TrinoSqlVisitor<Result>): Result | null;
}
export declare class IterateStatementContext extends ControlStatementContext {
    constructor(ctx: ControlStatementContext);
...
export declare class LoopStatementContext extends ControlStatementContext {
    _label?: IdentifierContext;
    constructor(ctx: ControlStatementContext);
...
export declare class ReturnStatementContext extends ControlStatementContext {
    constructor(ctx: ControlStatementContext);
...
export declare class IfStatementContext extends ControlStatementContext {
    constructor(ctx: ControlStatementContext);
    KW_IF(): antlr.TerminalNode[];
    KW_IF(i: number): antlr.TerminalNode | null;
    expression(): ExpressionContext;
    ...
    KW_END(): antlr.TerminalNode;
    elseIfClause(): ElseIfClauseContext[];
    elseIfClause(i: number): ElseIfClauseContext | null;
    elseClause(): ElseClauseContext | null;
    enterRule(listener: TrinoSqlListener): void;
    exitRule(listener: TrinoSqlListener): void;
    accept<Result>(visitor: TrinoSqlVisitor<Result>): Result | null;
}
export declare class SearchedCaseStatementContext extends ControlStatementContext {
    constructor(ctx: ControlStatementContext);
    KW_CASE(): antlr.TerminalNode[];
    KW_CASE(i: number): antlr.TerminalNode | null;
    KW_END(): antlr.TerminalNode;
...
export declare class CaseStatementWhenClauseContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
    KW_WHEN(): antlr.TerminalNode;
    expression(): ExpressionContext;
    KW_THEN(): antlr.TerminalNode;
...
export declare class ElseIfClauseContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
...
export declare class SqlStatementListContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
    controlStatement(): ControlStatementContext[];
    controlStatement(i: number): ControlStatementContext | null;
    SEMICOLON(): antlr.TerminalNode[];
    SEMICOLON(i: number): antlr.TerminalNode | null;
    get ruleIndex(): number;
    enterRule(listener: TrinoSqlListener): void;
...
export declare class EntityKindContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
...
export declare class GrantObjectContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
    qualifiedName(): QualifiedNameContext;
    entityKind(): EntityKindContext | null;
    get ruleIndex(): number;
    enterRule(listener: TrinoSqlListener): void;
    exitRule(listener: TrinoSqlListener): void;
    accept<Result>(visitor: TrinoSqlVisitor<Result>): Result | null;
...
export declare class TableOrViewNameContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
    tableRef(): TableRefContext | null;
    viewRef(): ViewRefContext | null;
    get ruleIndex(): number;
    enterRule(listener: TrinoSqlListener): void;
    exitRule(listener: TrinoSqlListener): void;
    accept<Result>(visitor: TrinoSqlVisitor<Result>): Result | null;
}
export declare class TableRefContext extends antlr.ParserRuleContext {
...
export declare class ViewRefContext extends antlr.ParserRuleContext {
...
export declare class SchemaRefContext extends antlr.ParserRuleContext {
    _schema?: IdentifierContext;
    _catalog?: IdentifierContext;
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
    identifier(): IdentifierContext[];
...
export declare class CatalogRefContext extends antlr.ParserRuleContext {
    _catalog?: IdentifierContext;
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
    identifier(): IdentifierContext;
    get ruleIndex(): number;
...
export declare class QueryPeriodContext extends antlr.ParserRuleContext {
...
export declare class RangeTypeContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
...
export declare class PrivilegeOrRoleContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
    KW_CREATE(): antlr.TerminalNode | null;
    KW_SELECT(): antlr.TerminalNode | null;
    KW_DELETE(): antlr.TerminalNode | null;
...
export declare class AuthorizationUserContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
    get ruleIndex(): number;
    copyFrom(ctx: AuthorizationUserContext): void;
}
export declare class StringUserContext extends AuthorizationUserContext {
...
export declare class IdentifierUserContext extends AuthorizationUserContext {
    constructor(ctx: AuthorizationUserContext);
    identifier(): IdentifierContext;
    enterRule(listener: TrinoSqlListener): void;
    exitRule(listener: TrinoSqlListener): void;
...
export declare class NonReservedContext extends antlr.ParserRuleContext {
    ...
    KW_DETERMINISTIC(): antlr.TerminalNode | null;
    KW_DISTRIBUTED(): antlr.TerminalNode | null;
    KW_DO(): antlr.TerminalNode | null;
    KW_DOUBLE(): antlr.TerminalNode | null;
    KW_ELSEIF(): antlr.TerminalNode | null;
    KW_EMPTY(): antlr.TerminalNode | null;
    KW_ENCODING(): antlr.TerminalNode | null;
    KW_ERROR(): antlr.TerminalNode | null;
    KW_EXCLUDING(): antlr.TerminalNode | null;
    ...
    KW_INVOKER(): antlr.TerminalNode | null;
    KW_IO(): antlr.TerminalNode | null;
    KW_ITERATE(): antlr.TerminalNode | null;
    ...
    KW_LEADING(): antlr.TerminalNode | null;
    KW_LEAVE(): antlr.TerminalNode | null;
    KW_LEVEL(): antlr.TerminalNode | null;
    KW_LIMIT(): antlr.TerminalNode | null;
    KW_LOCAL(): antlr.TerminalNode | null;
    KW_LOGICAL(): antlr.TerminalNode | null;
    KW_LOOP(): antlr.TerminalNode | null;
