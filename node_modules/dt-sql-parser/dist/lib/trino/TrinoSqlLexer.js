...
TrinoSqlLexer.T__16 = 17;
TrinoSqlLexer.KW_ABSENT = 18;
TrinoSqlLexer.KW_ADD = 19;
TrinoSqlLexer.KW_ADMIN = 20;
TrinoSqlLexer.KW_AFTER = 21;
TrinoSqlLexer.KW_ALL = 22;
TrinoSqlLexer.KW_ALTER = 23;
TrinoSqlLexer.KW_ANALYZE = 24;
TrinoSqlLexer.KW_AND = 25;
TrinoSqlLexer.KW_ANY = 26;
TrinoSqlLexer.KW_ARRAY = 27;
TrinoSqlLexer.KW_AS = 28;
TrinoSqlLexer.KW_ASC = 29;
TrinoSqlLexer.KW_AT = 30;
TrinoSqlLexer.KW_AUTHORIZATION = 31;
TrinoSqlLexer.KW_BEGIN = 32;
TrinoSqlLexer.KW_BERNOULLI = 33;
TrinoSqlLexer.KW_BETWEEN = 34;
TrinoSqlLexer.KW_BOTH = 35;
TrinoSqlLexer.KW_BY = 36;
TrinoSqlLexer.KW_CALL = 37;
TrinoSqlLexer.KW_CALLED = 38;
TrinoSqlLexer.KW_CASCADE = 39;
TrinoSqlLexer.KW_CASE = 40;
TrinoSqlLexer.KW_CAST = 41;
TrinoSqlLexer.KW_CATALOG = 42;
TrinoSqlLexer.KW_CATALOGS = 43;
TrinoSqlLexer.KW_COLUMN = 44;
TrinoSqlLexer.KW_COLUMNS = 45;
TrinoSqlLexer.KW_COMMENT = 46;
TrinoSqlLexer.KW_COMMIT = 47;
TrinoSqlLexer.KW_COMMITTED = 48;
TrinoSqlLexer.KW_CONDITIONAL = 49;
TrinoSqlLexer.KW_CONSTRAINT = 50;
TrinoSqlLexer.KW_COUNT = 51;
TrinoSqlLexer.KW_COPARTITION = 52;
TrinoSqlLexer.KW_CREATE = 53;
TrinoSqlLexer.KW_CROSS = 54;
TrinoSqlLexer.KW_CUBE = 55;
TrinoSqlLexer.KW_CURRENT = 56;
TrinoSqlLexer.KW_CURRENT_CATALOG = 57;
TrinoSqlLexer.KW_CURRENT_DATE = 58;
TrinoSqlLexer.KW_CURRENT_PATH = 59;
TrinoSqlLexer.KW_CURRENT_ROLE = 60;
TrinoSqlLexer.KW_CURRENT_SCHEMA = 61;
TrinoSqlLexer.KW_CURRENT_TIME = 62;
TrinoSqlLexer.KW_CURRENT_TIMESTAMP = 63;
TrinoSqlLexer.KW_CURRENT_USER = 64;
TrinoSqlLexer.KW_DATA = 65;
TrinoSqlLexer.KW_DATE = 66;
TrinoSqlLexer.KW_DAY = 67;
TrinoSqlLexer.KW_DEALLOCATE = 68;
TrinoSqlLexer.KW_DECLARE = 69;
TrinoSqlLexer.KW_DEFAULT = 70;
TrinoSqlLexer.KW_DEFINE = 71;
TrinoSqlLexer.KW_DEFINER = 72;
TrinoSqlLexer.KW_DELETE = 73;
TrinoSqlLexer.KW_DENY = 74;
TrinoSqlLexer.KW_DESC = 75;
TrinoSqlLexer.KW_DESCRIBE = 76;
TrinoSqlLexer.KW_DESCRIPTOR = 77;
TrinoSqlLexer.KW_DETERMINISTIC = 78;
TrinoSqlLexer.KW_DISTINCT = 79;
TrinoSqlLexer.KW_DISTRIBUTED = 80;
TrinoSqlLexer.KW_DO = 81;
TrinoSqlLexer.KW_DOUBLE = 82;
TrinoSqlLexer.KW_DROP = 83;
TrinoSqlLexer.KW_ELSE = 84;
TrinoSqlLexer.KW_EMPTY = 85;
TrinoSqlLexer.KW_ELSEIF = 86;
TrinoSqlLexer.KW_ENCODING = 87;
TrinoSqlLexer.KW_END = 88;
TrinoSqlLexer.KW_ERROR = 89;
TrinoSqlLexer.KW_ESCAPE = 90;
TrinoSqlLexer.KW_EXCEPT = 91;
TrinoSqlLexer.KW_EXCLUDING = 92;
TrinoSqlLexer.KW_EXECUTE = 93;
TrinoSqlLexer.KW_EXISTS = 94;
TrinoSqlLexer.KW_EXPLAIN = 95;
TrinoSqlLexer.KW_EXTRACT = 96;
TrinoSqlLexer.KW_FALSE = 97;
TrinoSqlLexer.KW_FETCH = 98;
TrinoSqlLexer.KW_FILTER = 99;
TrinoSqlLexer.KW_FINAL = 100;
TrinoSqlLexer.KW_FIRST = 101;
TrinoSqlLexer.KW_FOLLOWING = 102;
TrinoSqlLexer.KW_FOR = 103;
TrinoSqlLexer.KW_FORMAT = 104;
TrinoSqlLexer.KW_FROM = 105;
TrinoSqlLexer.KW_FULL = 106;
TrinoSqlLexer.KW_FUNCTION = 107;
TrinoSqlLexer.KW_FUNCTIONS = 108;
TrinoSqlLexer.KW_GRACE = 109;
TrinoSqlLexer.KW_GRANT = 110;
TrinoSqlLexer.KW_GRANTED = 111;
TrinoSqlLexer.KW_GRANTS = 112;
TrinoSqlLexer.KW_GRAPHVIZ = 113;
TrinoSqlLexer.KW_GROUP = 114;
TrinoSqlLexer.KW_GROUPING = 115;
TrinoSqlLexer.KW_GROUPS = 116;
TrinoSqlLexer.KW_HAVING = 117;
TrinoSqlLexer.KW_HOUR = 118;
TrinoSqlLexer.KW_IF = 119;
TrinoSqlLexer.KW_IGNORE = 120;
TrinoSqlLexer.KW_IMMEDIATE = 121;
TrinoSqlLexer.KW_IN = 122;
TrinoSqlLexer.KW_INCLUDING = 123;
TrinoSqlLexer.KW_INITIAL = 124;
TrinoSqlLexer.KW_INNER = 125;
TrinoSqlLexer.KW_INPUT = 126;
TrinoSqlLexer.KW_INSERT = 127;
TrinoSqlLexer.KW_INTERSECT = 128;
TrinoSqlLexer.KW_INTERVAL = 129;
TrinoSqlLexer.KW_INTO = 130;
TrinoSqlLexer.KW_INVOKER = 131;
TrinoSqlLexer.KW_IO = 132;
TrinoSqlLexer.KW_IS = 133;
TrinoSqlLexer.KW_ISOLATION = 134;
TrinoSqlLexer.KW_ITERATE = 135;
TrinoSqlLexer.KW_JOIN = 136;
TrinoSqlLexer.KW_JSON = 137;
TrinoSqlLexer.KW_JSON_ARRAY = 138;
TrinoSqlLexer.KW_JSON_EXISTS = 139;
TrinoSqlLexer.KW_JSON_OBJECT = 140;
TrinoSqlLexer.KW_JSON_QUERY = 141;
TrinoSqlLexer.KW_JSON_TABLE = 142;
TrinoSqlLexer.KW_JSON_VALUE = 143;
TrinoSqlLexer.KW_KEEP = 144;
TrinoSqlLexer.KW_KEY = 145;
TrinoSqlLexer.KW_KEYS = 146;
TrinoSqlLexer.KW_LANGUAGE = 147;
TrinoSqlLexer.KW_LAST = 148;
TrinoSqlLexer.KW_LATERAL = 149;
TrinoSqlLexer.KW_LEADING = 150;
TrinoSqlLexer.KW_LEAVE = 151;
TrinoSqlLexer.KW_LEFT = 152;
TrinoSqlLexer.KW_LEVEL = 153;
TrinoSqlLexer.KW_LIKE = 154;
TrinoSqlLexer.KW_LIMIT = 155;
TrinoSqlLexer.KW_LISTAGG = 156;
TrinoSqlLexer.KW_LOCAL = 157;
TrinoSqlLexer.KW_LOCALTIME = 158;
TrinoSqlLexer.KW_LOCALTIMESTAMP = 159;
TrinoSqlLexer.KW_LOGICAL = 160;
TrinoSqlLexer.KW_LOOP = 161;
TrinoSqlLexer.KW_MAP = 162;
TrinoSqlLexer.KW_MATCH = 163;
TrinoSqlLexer.KW_MATCHED = 164;
TrinoSqlLexer.KW_MATCHES = 165;
TrinoSqlLexer.KW_MATCH_RECOGNIZE = 166;
TrinoSqlLexer.KW_MATERIALIZED = 167;
TrinoSqlLexer.KW_MEASURES = 168;
TrinoSqlLexer.KW_MERGE = 169;
TrinoSqlLexer.KW_MINUTE = 170;
TrinoSqlLexer.KW_MONTH = 171;
TrinoSqlLexer.KW_NATURAL = 172;
TrinoSqlLexer.KW_NESTED = 173;
TrinoSqlLexer.KW_NEXT = 174;
TrinoSqlLexer.KW_NFC = 175;
TrinoSqlLexer.KW_NFD = 176;
TrinoSqlLexer.KW_NFKC = 177;
TrinoSqlLexer.KW_NFKD = 178;
TrinoSqlLexer.KW_NO = 179;
TrinoSqlLexer.KW_NONE = 180;
TrinoSqlLexer.KW_NORMALIZE = 181;
TrinoSqlLexer.KW_NOT = 182;
TrinoSqlLexer.KW_NULL = 183;
TrinoSqlLexer.KW_NULLIF = 184;
TrinoSqlLexer.KW_NULLS = 185;
TrinoSqlLexer.KW_OBJECT = 186;
TrinoSqlLexer.KW_OF = 187;
TrinoSqlLexer.KW_OFFSET = 188;
TrinoSqlLexer.KW_OMIT = 189;
TrinoSqlLexer.KW_ON = 190;
TrinoSqlLexer.KW_ONE = 191;
TrinoSqlLexer.KW_ONLY = 192;
TrinoSqlLexer.KW_OPTION = 193;
TrinoSqlLexer.KW_OR = 194;
TrinoSqlLexer.KW_ORDER = 195;
TrinoSqlLexer.KW_ORDINALITY = 196;
TrinoSqlLexer.KW_OUTER = 197;
TrinoSqlLexer.KW_OUTPUT = 198;
TrinoSqlLexer.KW_OVER = 199;
TrinoSqlLexer.KW_OVERFLOW = 200;
TrinoSqlLexer.KW_PARTITION = 201;
TrinoSqlLexer.KW_PARTITIONS = 202;
TrinoSqlLexer.KW_PASSING = 203;
TrinoSqlLexer.KW_PAST = 204;
TrinoSqlLexer.KW_PATH = 205;
TrinoSqlLexer.KW_PATTERN = 206;
TrinoSqlLexer.KW_PER = 207;
TrinoSqlLexer.KW_PERIOD = 208;
TrinoSqlLexer.KW_PERMUTE = 209;
TrinoSqlLexer.KW_PLAN = 210;
TrinoSqlLexer.KW_POSITION = 211;
TrinoSqlLexer.KW_PRECEDING = 212;
TrinoSqlLexer.KW_PRECISION = 213;
TrinoSqlLexer.KW_PREPARE = 214;
TrinoSqlLexer.KW_PRIVILEGES = 215;
TrinoSqlLexer.KW_PROPERTIES = 216;
TrinoSqlLexer.KW_PRUNE = 217;
TrinoSqlLexer.KW_QUOTES = 218;
TrinoSqlLexer.KW_RANGE = 219;
TrinoSqlLexer.KW_READ = 220;
TrinoSqlLexer.KW_RECURSIVE = 221;
TrinoSqlLexer.KW_REFRESH = 222;
TrinoSqlLexer.KW_RENAME = 223;
TrinoSqlLexer.KW_REPEAT = 224;
TrinoSqlLexer.KW_REPEATABLE = 225;
TrinoSqlLexer.KW_REPLACE = 226;
TrinoSqlLexer.KW_RESET = 227;
TrinoSqlLexer.KW_RESPECT = 228;
TrinoSqlLexer.KW_RESTRICT = 229;
TrinoSqlLexer.KW_RETURN = 230;
TrinoSqlLexer.KW_RETURNING = 231;
TrinoSqlLexer.KW_RETURNS = 232;
TrinoSqlLexer.KW_REVOKE = 233;
TrinoSqlLexer.KW_RIGHT = 234;
TrinoSqlLexer.KW_ROLE = 235;
TrinoSqlLexer.KW_ROLES = 236;
TrinoSqlLexer.KW_ROLLBACK = 237;
TrinoSqlLexer.KW_ROLLUP = 238;
TrinoSqlLexer.KW_ROW = 239;
TrinoSqlLexer.KW_ROWS = 240;
TrinoSqlLexer.KW_RUNNING = 241;
TrinoSqlLexer.KW_SCALAR = 242;
TrinoSqlLexer.KW_SCHEMA = 243;
TrinoSqlLexer.KW_SCHEMAS = 244;
TrinoSqlLexer.KW_SECOND = 245;
TrinoSqlLexer.KW_SECURITY = 246;
TrinoSqlLexer.KW_SEEK = 247;
TrinoSqlLexer.KW_SELECT = 248;
TrinoSqlLexer.KW_SERIALIZABLE = 249;
TrinoSqlLexer.KW_SESSION = 250;
TrinoSqlLexer.KW_SET = 251;
TrinoSqlLexer.KW_SETS = 252;
TrinoSqlLexer.KW_SHOW = 253;
TrinoSqlLexer.KW_SOME = 254;
TrinoSqlLexer.KW_START = 255;
TrinoSqlLexer.KW_STATS = 256;
TrinoSqlLexer.KW_SUBSET = 257;
TrinoSqlLexer.KW_SUBSTRING = 258;
TrinoSqlLexer.KW_SYSTEM = 259;
TrinoSqlLexer.KW_TABLE = 260;
TrinoSqlLexer.KW_TABLES = 261;
TrinoSqlLexer.KW_TABLESAMPLE = 262;
TrinoSqlLexer.KW_TEXT = 263;
TrinoSqlLexer.KW_TEXT_STRING = 264;
TrinoSqlLexer.KW_THEN = 265;
TrinoSqlLexer.KW_TIES = 266;
TrinoSqlLexer.KW_TIME = 267;
TrinoSqlLexer.KW_TIMESTAMP = 268;
TrinoSqlLexer.KW_TO = 269;
TrinoSqlLexer.KW_TRAILING = 270;
TrinoSqlLexer.KW_TRANSACTION = 271;
TrinoSqlLexer.KW_TRIM = 272;
TrinoSqlLexer.KW_TRUE = 273;
TrinoSqlLexer.KW_TRUNCATE = 274;
TrinoSqlLexer.KW_TRY_CAST = 275;
TrinoSqlLexer.KW_TYPE = 276;
TrinoSqlLexer.KW_UESCAPE = 277;
TrinoSqlLexer.KW_UNBOUNDED = 278;
TrinoSqlLexer.KW_UNCOMMITTED = 279;
TrinoSqlLexer.KW_UNCONDITIONAL = 280;
TrinoSqlLexer.KW_UNION = 281;
TrinoSqlLexer.KW_UNIQUE = 282;
TrinoSqlLexer.KW_UNKNOWN = 283;
TrinoSqlLexer.KW_UNMATCHED = 284;
TrinoSqlLexer.KW_UNNEST = 285;
TrinoSqlLexer.KW_UNTIL = 286;
TrinoSqlLexer.KW_UPDATE = 287;
TrinoSqlLexer.KW_USE = 288;
TrinoSqlLexer.KW_USER = 289;
TrinoSqlLexer.KW_USING = 290;
TrinoSqlLexer.KW_UTF16 = 291;
TrinoSqlLexer.KW_UTF32 = 292;
TrinoSqlLexer.KW_UTF8 = 293;
TrinoSqlLexer.KW_VALIDATE = 294;
TrinoSqlLexer.KW_VALUE = 295;
TrinoSqlLexer.KW_VALUES = 296;
TrinoSqlLexer.KW_VERBOSE = 297;
TrinoSqlLexer.KW_VERSION = 298;
TrinoSqlLexer.KW_VIEW = 299;
TrinoSqlLexer.KW_WHEN = 300;
TrinoSqlLexer.KW_WHERE = 301;
TrinoSqlLexer.KW_WHILE = 302;
TrinoSqlLexer.KW_WINDOW = 303;
TrinoSqlLexer.KW_WITH = 304;
TrinoSqlLexer.KW_WITHIN = 305;
TrinoSqlLexer.KW_WITHOUT = 306;
TrinoSqlLexer.KW_WORK = 307;
TrinoSqlLexer.KW_WRAPPER = 308;
TrinoSqlLexer.KW_WRITE = 309;
TrinoSqlLexer.KW_YEAR = 310;
TrinoSqlLexer.KW_ZONE = 311;
TrinoSqlLexer.EQ = 312;
TrinoSqlLexer.NEQ = 313;
TrinoSqlLexer.LT = 314;
TrinoSqlLexer.LTE = 315;
TrinoSqlLexer.GT = 316;
TrinoSqlLexer.GTE = 317;
TrinoSqlLexer.PLUS = 318;
TrinoSqlLexer.MINUS = 319;
TrinoSqlLexer.ASTERISK = 320;
TrinoSqlLexer.SLASH = 321;
TrinoSqlLexer.PERCENT = 322;
TrinoSqlLexer.CONCAT = 323;
TrinoSqlLexer.QUESTION_MARK = 324;
TrinoSqlLexer.SEMICOLON = 325;
TrinoSqlLexer.STRING = 326;
TrinoSqlLexer.UNICODE_STRING = 327;
TrinoSqlLexer.BINARY_LITERAL = 328;
TrinoSqlLexer.INTEGER_VALUE = 329;
TrinoSqlLexer.DECIMAL_VALUE = 330;
TrinoSqlLexer.DOUBLE_VALUE = 331;
TrinoSqlLexer.IDENTIFIER = 332;
TrinoSqlLexer.DIGIT_IDENTIFIER = 333;
TrinoSqlLexer.QUOTED_IDENTIFIER = 334;
TrinoSqlLexer.BACKQUOTED_IDENTIFIER = 335;
TrinoSqlLexer.SIMPLE_COMMENT = 336;
TrinoSqlLexer.BRACKETED_COMMENT = 337;
TrinoSqlLexer.WS = 338;
TrinoSqlLexer.UNRECOGNIZED = 339;
