...
.c9-menu-bar:before {
    ...
    background-image: url(c9-repeat-x_flat_light@1x.png);
...
.c9-mbar-round {
    ...
    background-image: url(c9-no-repeat_flat_light@1x.png);
...
.updateAvailable .c9-mbar-round .mainlogo {
    background: url("c9-no-repeat_flat_light@1x.png") no-repeat -96px -44px;
    cursor: pointer;
}
...
.c9-menu-bar .c9-mbar-bcont .c9-activity {
    background: url("c9-no-repeat_flat_light@1x.png") no-repeat -84px 0;
    height: 10px;
    left: 24px;
    pointer-events: all;
    position: absolute;
...
.c9-menu-bar .c9-mbar-bcont .c9-activity .light {
    background: url("c9-no-repeat_flat_light@1x.png") no-repeat -102px -19px;
    /* nothing */
    height: 10px;
    left: 0;
    position: absolute;
...
/* @file @c9/ide/plugins/c9.ide.layout.classic/less/c9-simple-btn.less */
.c9-simple-btn {
    -webkit-user-select: none"; -moz-user-select: none; -ms-user-select: none"; user-select: none;
    cursor: default;
}
...
.c9menu > div.submenu > span {
    background: url("../images/submenu_arrow.gif") no-repeat right 0;
    width: 4px;
    height: 7px;
    display: block;
    position: absolute;
